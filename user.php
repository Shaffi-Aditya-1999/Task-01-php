...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 d-flex">
    ...
    <a href="logout.php" class="btn btn-info ms-3"
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "
            <tr>
                ...
                <td>{$row['ESAL']}</td>
                <td>
                    <a href='uploads/{$row['attachment']}' target='_blank' class='btn btn-info btn-sm'>View</a>
                </td>
            </tr>";
    }
    ...
    echo "<h3 class='text-center mt-4'>No Records Found</h3>";
}
